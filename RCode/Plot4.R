...
par(mfrow=c(2,2))
plot(hhpc1$DateTime, hhpc1[,3], type="l", xlab="",ylab="Global Active Power", col="black")
plot(hhpc1$DateTime, hhpc1[,5], type="l", xlab="datetime",ylab="Voltage", col="black")
...
plot(hhpc1$DateTime, hhpc1[,4], type="l", xlab="datetime",ylab="Global_reactive_power",col="black")
dev.off()
